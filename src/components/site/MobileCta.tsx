...
export function MobileCta() {
  return (
    ...
    >
      <span className="hidden max-w-0 whitespace-nowrap text-sm font-bold opacity-0 transition-all duration-200 md:inline-block md:group-hover:max-w-20 md:group-hover:opacity-100">
        Contact
      </span>
